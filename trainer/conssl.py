""" The Code is ConSSL, consists of four parts:
1. supervised module
2. unsupervised module
3. instance-level contrastive module
4. class-level contrastive module
"""
import argparse
import copy
import logging
...
class ConSSL(Trainer):
    ...
    def compute_loss_sim(self, feature_1, feature_2, emb_i, emb_j):
        temperature = 0.5 
        batch_size = self.all_cfg.data.batch_size * self.all_cfg.data.mu
    ...
    def compute_loss(self,
        ...
        if self.pseudo_with_ema:
            ...
            logits_u_w, logits_u_s, logits_u_s2 = logits[batch_size:].chunk(3)
        ...
        """loss_sim.item()"""
        loss_sim = self.compute_loss_sim(f_u_s1, f_u_s2, logits_u_s, logits_u_s2)
        # print("loss_sim=",loss_sim.item())
        loss = Lx + self.cfg.lambda_u * Lu + self.cfg.lambda_contrast * Lcontrast + self.cfg.lambda_sim *loss_sim
